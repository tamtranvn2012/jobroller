...
function jr_get_featured_jobs() {
	...
	$args = array(
		...
		'post_status' 	=> 'publish',
		'posts_per_page'=> jt_get_featured_jobs_per_page(),
	);
	...
	} elseif ( is_front_page() || is_archive( APP_POST_TYPE ) ) {
...
function _jr_display_featured_jobs() {
	...
	$condition = ! is_search( APP_POST_TYPE ) && ( is_front_page() || is_archive( APP_POST_TYPE ) || is_tax() );
