	...
	<table cellpadding="0" cellspacing="0" class="data_list">
		<thead>
			<tr>
				...
				<th class="center"><?php _e('Date',APP_TD); ?></th>
				<th class="left"><?php _e('Order Summary',APP_TD); ?></th>
				<th class="center"><?php _e('Price',APP_TD); ?></th>
				<th class="center"><?php _e('Payment/Status',APP_TD); ?></th>
