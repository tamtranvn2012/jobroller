				...
				<?php 
					if ( 'yes' == get_option('jr_allow_job_seekers') ) :
						if (!$role) :
							?>
							<p class="role">
								<label><input type="radio" name="role" tabindex="5" value="job_lister" <?php checked( isset($posted['role']) && $posted['role']=='job_lister' ); ?> /> <?php _e( 'I am an <strong>Employer</strong>', APP_TD ); ?></label>
