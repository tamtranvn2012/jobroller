<?php
	...
	ob_start();
?>
<?php if ( $my_query && $my_query->have_posts() ) : $alt = 1; echo '<div class="section"><h2 class="pagetitle"><span> '.__('Featured Jobs',APP_TD).'</span></h2><ol class="jobs">'; while ($my_query->have_posts()) : $my_query->the_post(); 
