 ...
 * @param  string $override_format   The format the value is in (defaults to 'currency_format')
 * @return string                    The formatted price
 */
function appthemes_get_price( $price, $override_currency = '', $override_format = '' ){
	...
	$currency_format = ( empty( $override_format ) ) ? $format_args['currency_format'] : $override_format;

	$position = $format_args['currency_position'];
	$identifier = APP_Currencies::get_currency( $currency_code, $currency_format );
