...
<li class="widget widget_user_options">
	...
	<h2 class="widget_title headingbg"><?php _e('Account Options',APP_TD); ?></h2>

	<div class="widget_content account">
		<ul>
...
<li class="widget widget_user_info">
	...
	<h2 class="widget_title headingbg"><?php _e('Account Info',APP_TD); ?></h2>
