	...
	<div class="section">
		...
		<div class="section_content">
			...
			<ul class="display_section">
				...
				<?php if ( jr_resume_is_visible() || $can_subscribe ) : ?><li><a href="#subscriptions" class="noscroll"><?php _e('Subscriptions', APP_TD); ?></a></li><?php endif; ?>
				<?php if ( jr_job_alerts_auth() ): ?>	<li><a href="#alerts" class="noscroll"><?php _e('Job Alerts', APP_TD); ?></a></li>	<?php endif; ?>
				<?php if ( jr_charge_job_listings() || $can_subscribe ) : ?><li><a href="#orders" class="noscroll"><?php _e('Orders', APP_TD); ?></a></li><?php endif; ?>
