        ...
        <?php while (have_posts()) : the_post(); ?>
            ...
            <li class="<?php echo implode(' ', $post_class); ?>">
                ...
                <dl>
                    ...
                    <dd class="type"><?php // jr_get_custom_taxonomy($post->ID, 'job_type', 'jtype'); ?><?php if (has_post_thumbnail()) the_post_thumbnail(); ?></dd>
                    ...
                    <dd class="date"><?php echo date_i18n(__('j M',APP_TD), strtotime($post->post_date)); ?> <span class="year"><?php echo date_i18n(__('Y',APP_TD), strtotime($post->post_date)); ?></span></dd>
