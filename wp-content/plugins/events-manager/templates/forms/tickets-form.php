...
<div id="em-tickets-form" style="display:none" title="<?php _e('Create a ticket', 'dbem'); ?>">
	<form action="" method="post">
		<fieldset>
			...
			<div><label><?php _e('Required?','dbem') ?></label> <input type="checkbox" name="ticket_required" value="1" /> <a href="#" onclick="return false;" title="<?php _e('If checked every booking must select one or the minimum number of this ticket.','dbem'); ?>">?</a></div>
