...
?>
		<div class="clear"></div>
		<div class="paging">
			<?php appthemes_pagenavi( $new_wp_query, $query_var, $args ); ?>
...
function jt_get_jobs_per_page() {
	global $app_abbr;
	return get_option( $app_abbr . '_jobs_per_page', 10 );
}

function jt_get_featured_jobs_per_page() {
	global $app_abbr;
	return get_option( $app_abbr . '_featured_jobs_per_page', -1 );
}
...
function jt_get_resumes_per_page() {
	global $app_abbr;
	return get_option( $app_abbr . '_resumes_per_page', 10 );
}
