	...
	<div class="section">
		...
		<div class="section_content">
			...
			<ul class="display_section">
				...
				<li><a href="#events" class="noscroll"><?php _e('Dashboard', APP_TD); ?></a></li>
				<li><a href="#resumes" class="noscroll"><?php _e('Resumes/Attachments', APP_TD); ?></a></li>
				...
				<li><a href="#dashboard" class="noscroll"><?php _e('Events', APP_TD); ?></a></li>
			...
			<div id="events" class="myprofile_section">
