...
?>
	...
	<div class="section">
		...
		<h2 class="pagetitle">
			...
			<small class="rss"><a href="<?php echo add_query_arg( 'post_type', APP_POST_TYPE, get_bloginfo('rss2_url') ); ?>"><img src="<?php bloginfo('template_url'); ?>/images/feed.png" title="<?php _e('Latest Jobs RSS Feed',APP_TD); ?>" alt="<?php _e('Latest Jobs RSS Feed',APP_TD); ?>" /></a></small>
